...
type LiveReadyTokenResult = Extract<LiveTokenResult, { status: 'ready' }>;
...
export function useVoiceSession(): VoiceSessionState & VoiceSessionControls {
  ...
  const tokenResultRef = useRef<LiveReadyTokenResult | null>(null);
  ...
  const connectWebSocket = useCallback(
    (tokenResult: LiveReadyTokenResult, systemContext: string) => {
